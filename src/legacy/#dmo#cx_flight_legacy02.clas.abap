CLASS /dmo/cx_flight_legacy02 DEFINITION
  PUBLIC
  ...
  PUBLIC SECTION.
    ...
    CONSTANTS:
      gc_msgid TYPE symsgid VALUE '/DMO/CM_FLIGHT_LE_02',

      BEGIN OF agency_unkown,
        msgid TYPE symsgid VALUE '/DMO/CM_FLIGHT_LE_02',
    ...
    METHODS constructor
      IMPORTING
        ...
        travel_id             TYPE /dmo/travel_id02 OPTIONAL
        booking_id            TYPE /dmo/booking_id02 OPTIONAL
        booking_supplement_id TYPE /dmo/booking_supplement_id02 OPTIONAL
        agency_id             TYPE /dmo/agency_id02 OPTIONAL
        customer_id           TYPE /dmo/customer_id02 OPTIONAL
        carrier_id            TYPE /dmo/carrier02-carrier_id OPTIONAL
        connection_id         TYPE /dmo/connecti_02-connection_id OPTIONAL
        supplement_id         TYPE /dmo/suppleme_02-supplement_id OPTIONAL
        begin_date            TYPE /dmo/begin_date02 OPTIONAL
        end_date              TYPE /dmo/end_date02 OPTIONAL
        booking_date          TYPE /dmo/booking_date02 OPTIONAL
        flight_date           TYPE /dmo/flight_date02 OPTIONAL
        status                TYPE /dmo/travel_status02 OPTIONAL
        currency_code         TYPE /dmo/currency_code02 OPTIONAL
        uname                 TYPE syuname OPTIONAL.

    DATA: mv_travel_id             TYPE /dmo/travel_id02,
          mv_booking_id            TYPE /dmo/booking_id02,
          mv_booking_supplement_id TYPE /dmo/booking_supplement_id02,
          mv_agency_id             TYPE /dmo/agency_id02,
          mv_customer_id           TYPE /dmo/customer_id02,
          mv_carrier_id            TYPE /dmo/carrier02-carrier_id,
          mv_connection_id         TYPE /dmo/connecti_02-connection_id,
          mv_supplement_id         TYPE /dmo/suppleme_02-supplement_id,
          mv_begin_date            TYPE /dmo/begin_date02,
          mv_end_date              TYPE /dmo/end_date02,
          mv_booking_date          TYPE /dmo/booking_date02,
          mv_flight_date           TYPE /dmo/flight_date02,
          mv_status                TYPE /dmo/travel_status02,
          mv_currency_code         TYPE /dmo/currency_code02,
...
CLASS /dmo/cx_flight_legacy02 IMPLEMENTATION.
